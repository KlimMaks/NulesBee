...
<head>
    ...
    <title>Локації - Редагування</title>
                ...
                <div class="container px-5">
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        <div class="text-center mb-5">
                            <h1 class="fw-bolder">Редагування локації</h1>
                            <p class="lead fw-normal text-muted mb-0">Заповніть поля</p>
                        </div>
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="edit_location.php" method="post">
                                   <div class="form-floating mb-3">
                                        <input class="form-control" id="id" name="id" type="text" placeholder="Введіть код"/>
                                        <label for="name">Код локації</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="locName" name="locName" type="text" placeholder="Введіть назву"/>
                                        <label for="name">Назва локації</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="pict" name="pict" type="text" placeholder="Вставте URL зображення"/>
